...
namespace AsciiGame
{
    ...
    /// </summary>
    public class DebugLogConsole : Console
    {
        private string _lastMessage;
        private int _lastMessageCount;

        public DebugLogConsole(int width, int height)
            : base(width, height)
        {
            Initialize();
        }

        public DebugLogConsole(int width, int height, int bufferWidth, int bufferHeight)
            : base(width, height, bufferWidth, bufferHeight)
        {
            Initialize();
        }

        public DebugLogConsole(ICellSurface surface, IFont font = null, Point? fontSize = null)
